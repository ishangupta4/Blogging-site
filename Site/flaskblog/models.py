...
class User(db.Model, UserMixin):
    ...
    connected_users=db.Column(db.String(100000), default="")
...
class Post(db.Model):
    ...
    liked_users = db.Column(db.String(100000),default="")
...
class Message(db.Model):
    ...
    def __repr__(self):
        return f"Message('{self.date_of_message}','{self.receiver_id}')"        